...
Status ImpalaServer::SetQueryInflight(shared_ptr<SessionState> session_state,
  ...
  int64_t max_cpu_time_ns = request_state->query_options().max_cpu_time_ns;
  ...
  if (idle_timeout_s > 0 || exec_time_limit_s > 0 ||
    ...
    if (idle_timeout_s > 0) {
      ...
      queries_by_timestamp_.emplace(ExpirationEvent{
          now + (1000L * idle_timeout_s), max_cpu_time_ns, max_scan_bytes,
    ...
    if (exec_time_limit_s > 0) {
      ...
      queries_by_timestamp_.emplace(ExpirationEvent{
          now + (1000L * exec_time_limit_s),  max_cpu_time_ns, max_scan_bytes,
    ...
    if (max_cpu_time_ns > 0) {
      ...
      queries_by_timestamp_.emplace(ExpirationEvent{
          now + (1000L),  max_cpu_time_ns, max_scan_bytes,
    ...
    int64_t now;
    {
      ...
      while (expiration_event != queries_by_timestamp_.end()) {
        ...
        if (expiration_event->kind == ExpirationKind::RESOURCE_LIMIT) {
          ...
          if (query_state->query_options().max_cpu_time_ns > 0 &&
              cpu_time_ns > max_cpu_time_ns) {
          ...
          if (query_state->query_options().max_scan_bytes > 0 &&
